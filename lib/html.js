...
module.exports.attr = function(options) {
...
module.exports.css = function(list, options) {
...
module.exports.js = function(context) {
...
module.exports.ul = function(context, options) {
...
module.exports.ol = function(context, options) {
...
module.exports.thumbnailImage = function(context) {
  var figure = '';
  var image = '';
