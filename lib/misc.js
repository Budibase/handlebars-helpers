...
module.exports.frame = function(context, options) {
...
module.exports.option = function(prop, locals, options) {
...
module.exports.noop = function(options) {
...
module.exports.typeOf = function(val) { return typeof val; };
...
module.exports.withHash = function(options) {
