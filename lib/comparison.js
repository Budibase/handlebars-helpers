...
module.exports.compare = function(a, operator, b, options) {
  /*eslint eqeqeq: 0*/
...
module.exports.contains = function(collection, value, startIndex, options) {
...
module.exports.gt = function(a, b, options) {
  if (arguments.length === 2) {
    options = b;
    b = options.hash.compare;
  }
...
module.exports.gte = function(a, b, options) {
  if (arguments.length === 2) {
    options = b;
    b = options.hash.compare;
  }
...
module.exports.has = function(value, pattern, options) {
...
module.exports.isFalsey = function(val, options) {
...
module.exports.isTruthy = function(val, options) {
  return util.value(!falsey(val), this, options);
};
...
module.exports.ifEven = function(num, options) {
...
module.exports.ifNth = function(a, b, options) {
...
module.exports.ifOdd = function(val, options) {
...
module.exports.is = function(a, b, options) {
  if (arguments.length === 2) {
    options = b;
    b = options.hash.compare;
  }
...
module.exports.isnt = function(a, b, options) {
  if (arguments.length === 2) {
    options = b;
    b = options.hash.compare;
  }
...
module.exports.lt = function(a, b, options) {
  if (arguments.length === 2) {
    options = b;
    b = options.hash.compare;
  }
...
module.exports.lte = function(a, b, options) {
  if (arguments.length === 2) {
    options = b;
    b = options.hash.compare;
  }
...
module.exports.neither = function(a, b, options) {
  return util.value(!a && !b, this, options);
};
...
module.exports.not = function(val, options) {
  return util.value(!val, this, options);
};
...
module.exports.or = function(/* any, any, ..., options */) {
  var len = arguments.length - 1;
  var options = arguments[len];
  var val = false;
...
module.exports.unlessEq = function(a, b, options) {
  if (util.isOptions(b)) {
    options = b;
    b = options.hash.compare;
  }
...
module.exports.unlessGt = function(a, b, options) {
  if (util.isOptions(b)) {
    options = b;
    b = options.hash.compare;
  }
...
module.exports.unlessLt = function(a, b, options) {
  if (util.isOptions(b)) {
    options = b;
    b = options.hash.compare;
  }
...
module.exports.unlessGteq = function(a, b, options) {
  if (util.isOptions(b)) {
    options = b;
    b = options.hash.compare;
  }
...
module.exports.unlessLteq = function(a, b, options) {
  if (util.isOptions(b)) {
    options = b;
    b = options.hash.compare;
  }
