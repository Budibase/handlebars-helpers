...
import { falsey } from './utils/falsey';
import { isOdd } from './utils/odd';
...
export const isFalsey = function (val, options) {
...
export const isTruthy = function (val, options) {
  return util.value(!falsey(val), this, options);
};
...
export const not = function (val, options) {
  return util.value(!val, this, options);
};
...
export const unlessEq = function (a, b, options) {
  if (util.isOptions(b)) {
    options = b;
    b = options.hash.compare;
  }
...
export const unlessGt = function (a, b, options) {
  if (util.isOptions(b)) {
    options = b;
    b = options.hash.compare;
  }
...
export const unlessLt = function (a, b, options) {
  if (util.isOptions(b)) {
    options = b;
    b = options.hash.compare;
  }
...
export const unlessGteq = function (a, b, options) {
  if (util.isOptions(b)) {
    options = b;
    b = options.hash.compare;
  }
...
export const unlessLteq = function (a, b, options) {
  if (util.isOptions(b)) {
    options = b;
    b = options.hash.compare;
  }
