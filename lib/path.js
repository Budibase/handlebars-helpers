...
module.exports.absolute = function(filepath, options) {
...
module.exports.dirname = function(filepath, options) {
...
module.exports.relative = function(a, b) {
  if (typeof a !== 'string') {
...
module.exports.basename = function(filepath) {
  if (typeof filepath !== 'string') {
    throw new TypeError(util.expectedType('filepath', 'string', filepath));
  }
...
module.exports.stem = function(filepath) {
  if (typeof filepath !== 'string') {
    throw new TypeError(util.expectedType('filepath', 'string', filepath));
  }
...
module.exports.extname = function(filepath) {
  if (typeof filepath !== 'string') {
    throw new TypeError(util.expectedType('filepath', 'string', filepath));
  }
...
module.exports.segments = function(filepath, a, b) {
  if (typeof filepath !== 'string') {
    throw new TypeError(util.expectedType('filepath', 'string', filepath));
  }
