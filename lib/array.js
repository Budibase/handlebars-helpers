...
module.exports.after = function(array, n) {
...
module.exports.arrayify = function(value) {
...
module.exports.before = function(array, n) {
  if (util.isUndefined(array)) return '';
  array = util.result(array);
  if (Array.isArray(array)) {
...
module.exports.eachIndex = function(array, options) {
  var result = '';
  if (util.isUndefined(array)) return '';
  array = util.result(array);
  if (Array.isArray(array)) {
...
module.exports.filter = function(array, value, options) {
...
module.exports.first = function(array, n) {
  if (util.isUndefined(array)) return [];
  array = util.result(array);
  if (Array.isArray(array)) {
    if (isNaN(n)) {
...
module.exports.forEach = function(array, options) {
  if (util.isUndefined(array)) return options.inverse(this);
  array = util.result(array);
  if (Array.isArray(array)) {
...
module.exports.inArray = function(array, value, options) {
  if (util.isUndefined(array)) return '';
  array = util.result(array);
  if (Array.isArray(array)) {
...
module.exports.itemAt = function(array, idx) {
...
module.exports.join = function(array, separator) {
  if (util.isUndefined(array)) return '';
...
module.exports.equalsLength = function(value, length, options) {
  if (util.isOptions(length)) {
    options = length;
    length = 0;
  }

  var len = module.exports.length(value);
...
module.exports.last = function(array, n) {
  if (util.isUndefined(array)) return '';
...
module.exports.length = function(array) {
...
module.exports.lengthEqual = module.exports.equalsLength;
...
module.exports.map = function(array, iter) {
  if (util.isUndefined(array)) return '';
...
module.exports.pluck = function(array, prop) {
  if (util.isUndefined(array)) return '';
  array = util.result(array);
  if (Array.isArray(array)) {
    var res = [];
...
module.exports.some = function(array, iter, options) {
  if (util.isUndefined(array)) return options.inverse(this);
  array = util.result(array);
  if (Array.isArray(array)) {
    for (var i = 0; i < array.length; i++) {
...
module.exports.sortBy = function(array, prop, options) {
  if (util.isUndefined(array)) return '';
  array = util.result(array);
  if (Array.isArray(array)) {
...
module.exports.withAfter = function(array, idx, options) {
  if (util.isUndefined(array)) return '';
  array = util.result(array);
  if (Array.isArray(array)) {
...
module.exports.withBefore = function(array, idx, options) {
  if (util.isUndefined(array)) return '';
  array = util.result(array);
  if (Array.isArray(array)) {
...
module.exports.withFirst = function(array, idx, options) {
  if (util.isUndefined(array)) return '';
  array = util.result(array);
  if (Array.isArray(array)) {
...
module.exports.withGroup = function(array, size, options) {
  if (util.isUndefined(array)) return '';
  var result = '';
  array = util.result(array);
...
module.exports.withLast = function(array, idx, options) {
  if (util.isUndefined(array)) return '';
  array = util.result(array);
  if (Array.isArray(array)) {
    if (!util.isUndefined(idx)) {
...
module.exports.withSort = function(array, prop, options) {
  if (util.isUndefined(array)) return '';
  array = util.result(array);
  if (Array.isArray(array)) {
    var result = '';
...
module.exports.unique = function(array, options) {
  if (util.isUndefined(array)) return '';
