...
import { Utils as util } from 'handlebars';
...
export const itemAt = function(array, idx) {
...
export const join = function(array, separator) {
  if (util.isUndefined(array)) return '';
...
export const equalsLength = function(value, len, options) {
  if (util.isOptions(len)) {
    options = len;
    len = 0;
  }

  return util.value(length(value) === len, this, options);
};
...
export const lengthEqual = equalsLength;
...
export const map = function(array, iter) {
  if (util.isUndefined(array)) return '';
...
export const pluck = function(array, prop) {
  if (util.isUndefined(array)) return '';
  array = util.result(array);
  if (Array.isArray(array)) {
    var res = [];
...
export const some = function(array, iter, options) {
  if (util.isUndefined(array)) return options.inverse(this);
  array = util.result(array);
  if (Array.isArray(array)) {
    for (var i = 0; i < array.length; i++) {
...
export const sort = function(array, options) {
  if (util.isUndefined(array)) return '';
  array = util.result(array);
  if (Array.isArray(array)) {
...
export const sortBy = function(array, prop, options) {
  if (util.isUndefined(array)) return '';
  array = util.result(array);
  if (Array.isArray(array)) {
...
export const withFirst = function(array, idx, options) {
  if (util.isUndefined(array)) return '';
  array = util.result(array);
  if (Array.isArray(array)) {
...
export const withGroup = function(array, size, options) {
  if (util.isUndefined(array)) return '';
  var result = '';
  array = util.result(array);
...
export const withLast = function(array, idx, options) {
  if (util.isUndefined(array)) return '';
  array = util.result(array);
  if (Array.isArray(array)) {
    if (!util.isUndefined(idx)) {
...
export const withSort = function(array, prop, options) {
  if (util.isUndefined(array)) return '';
  array = util.result(array);
  if (Array.isArray(array)) {
    var result = '';
...
export const unique = function(array, options) {
  if (util.isUndefined(array)) return '';
