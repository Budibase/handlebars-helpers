...
module.exports.condense = function(str) {
  return str.replace(/(\r\n|\r|\n|\u2028|\u2029) {2,}/g, '\n');
};
...
module.exports.padcomments = function(str) {
...
module.exports.parseAttributes = function parseAttributes(hash) {
...
module.exports.toAttributes = function toAttributes(hash) {
  var res = '';
