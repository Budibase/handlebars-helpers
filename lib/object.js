...
module.exports.extend = function(/*objects*/) {
...
module.exports.forIn = function(obj, options) {
...
module.exports.forOwn = function(obj, options) {
  if (!util.isOptions(options)) {
    return obj.inverse(this);
  }
...
module.exports.toPath = function(/*prop*/) {
  var prop = [];
...
module.exports.get = function(prop, context, options) {
...
module.exports.getObject = function(prop, context) {
...
module.exports.hasOwn = function(context, key) {
...
module.exports.JSONparse = function(str, options) {
...
module.exports.JSONstringify = function(obj, indent) {
  if (isNaN(indent)) {
    indent = 0;
  }
...
module.exports.merge = function(context/*, objects, options*/) {
  var args = [].slice.call(arguments);
  var opts = {};
...
module.exports.parseJSON = module.exports.JSONparse;
...
module.exports.pick = function(props, context, options) {
  var keys = array.arrayify(props);
  var len = keys.length, i = -1;
  var result = {};

  while (++i < len) {
    result = module.exports.extend({}, result, getObject(context, keys[i]));
  }
...
module.exports.stringify = module.exports.JSONstringify;
