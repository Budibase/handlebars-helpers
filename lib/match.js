...
module.exports.match = function(files, patterns, locals, options) {
...
module.exports.isMatch = function(files, patterns, locals, options) {
  var opts = util.options(this, locals, options);
...
module.exports.mm = function() {
  ...
  return module.exports.match.apply(this, arguments);
};
