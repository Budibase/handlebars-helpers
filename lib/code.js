...
const codeBlock = require('to-gfm-code-block');
...
module.exports.embed = function embed(filepath, ext) {
...
module.exports.gist = function(id) {
...
module.exports.jsfiddle = function jsFiddle(options) {
