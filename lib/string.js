...
module.exports.append = function(str, suffix) {
...
module.exports.capitalizeAll = function(str) {
  if (typeof(str) !== 'string') return '';
  if (util.isString(str)) {
    return str.replace(/\w\S*/g, function(word) {
      return module.exports.capitalize(word);
    });
  }
};
...
module.exports.center = function(str, spaces) {
  if (typeof(str) !== 'string') return '';
  var space = '';
  var i = 0;
  while (i < spaces) {
...
module.exports.chop = function(str) {
  if (typeof(str) !== 'string') return '';
...
module.exports.dashcase = function(str) {
  if (typeof(str) !== 'string') return '';
  return utils.changecase(str, function(ch) {
    return '-' + ch;
  });
...
module.exports.dotcase = function(str) {
  if (typeof(str) !== 'string') return '';
  return utils.changecase(str, function(ch) {
    return '.' + ch;
  });
...
module.exports.downcase = function() {
  return module.exports.lowercase.apply(this, arguments);
};
...
module.exports.ellipsis = function(str, limit) {
  if (util.isString(str)) {
    if (str.length <= limit) {
      return str;
    }
    return module.exports.truncate(str, limit) + '…';
  }
};
...
module.exports.occurrences = function(str, substring) {
  if (typeof(str) !== 'string') return '';
...
module.exports.pascalcase = function(str) {
  if (typeof(str) !== 'string') return '';
...
module.exports.pathcase = function(str) {
  if (typeof(str) !== 'string') return '';
  return utils.changecase(str, function(ch) {
    return '/' + ch;
  });
...
module.exports.plusify = function(str, ch) {
  if (typeof(str) !== 'string') return '';
...
module.exports.prepend = function(str, prefix) {
...
module.exports.remove = function(str, ch) {
  if (typeof(str) !== 'string') return '';
...
module.exports.removeFirst = function(str, ch) {
  if (typeof(str) !== 'string') return '';
  if (!util.isString(ch)) return str;
...
module.exports.replace = function(str, a, b) {
  if (typeof(str) !== 'string') return '';
...
module.exports.replaceFirst = function(str, a, b) {
  if (typeof(str) !== 'string') return '';
  if (!util.isString(a)) return str;
  if (!util.isString(b)) b = '';
...
module.exports.reverse = require('./array').reverse;
...
module.exports.sentence = function(str) {
  if (typeof(str) !== 'string') return '';
...
module.exports.split = function(str, ch) {
  if (typeof(str) !== 'string') return '';
  if (!util.isString(ch)) ch = ',';
  return str.split(ch);
};
...
module.exports.startsWith = function(prefix, str, options) {
...
module.exports.trimLeft = function(str) {
  if (util.isString(str)) {
...
module.exports.trimRight = function(str) {
  if (util.isString(str)) {
    return str.replace(/\s+$/, '');
  }
};
...
module.exports.truncate = function(str, limit, suffix) {
  if (util.isString(str)) {
...
module.exports.truncateWords = function(str, count, suffix) {
...
module.exports.upcase = function() {
  return module.exports.uppercase.apply(this, arguments);
};
...
module.exports.uppercase = function(str) {
  if (util.isObject(str) && str.fn) {
...
module.exports.lorem = function(num) {
