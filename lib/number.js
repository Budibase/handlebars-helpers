...
module.exports.bytes = function(number, precision, options) {
...
module.exports.addCommas = function(num) {
...
module.exports.phoneNumber = function(num) {
  num = num.toString();
...
module.exports.toAbbr = function(number, precision) {
  if (isNaN(number)) {
    number = 0;
  }
...
module.exports.toExponential = function(number, digits) {
  if (isNaN(number)) {
    number = 0;
  }
...
module.exports.toFixed = function(number, digits) {
  if (isNaN(number)) {
    number = 0;
  }
  if (isNaN(digits)) {
...
module.exports.toFloat = function(number) {
...
module.exports.toInt = function(number) {
...
module.exports.toPrecision = function(number, precision) {
  if (isNaN(number)) {
    number = 0;
  }
  if (isNaN(precision)) {
