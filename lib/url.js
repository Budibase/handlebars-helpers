...
module.exports.urlResolve = function(base, href) {
...
module.exports.urlParse = function(str) {
...
module.exports.stripQuerystring = function(str) {
  if (util.isString(str)) {
    return str.split('?')[0];
  }
};
...
module.exports.stripProtocol = function(str) {
  if (util.isString(str)) {
