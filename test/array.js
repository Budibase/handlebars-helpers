...
describe("array", function () {
  ...
  describe("join", function () {
    ...
    it("should join items by the default separator", function () {
      assert.equal(
        hbs.compile("{{join array}}")(context),
        "a, b, c, d, e, f, g, h"
      );
    });
  ...
  describe("sort", function () {
    ...
    it("should be able to sort the items in a frozen array in reverse order", function () {
      var fn = hbs.compile('{{sort array reverse="true"}}');
      var res = fn({ array: Object.freeze(["c", "a", "b"]) });
      assert.equal(res, "c,b,a");
    });
  ...
  describe("sortBy", function () {
    ...
    it("should sort the items in a frozen array", function () {
      var fn = hbs.compile("{{sortBy array}}");
      assert.equal(fn({ array: Object.freeze(["b", "c", "a"]) }), "a,b,c");
    });
